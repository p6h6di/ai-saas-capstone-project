      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 size-16 rounded-full border-2 border-white object-cover object-center !p-0 transition duration-500 group-hover:z-30  group-hover:scale-105"
          />
        </div>
      ))}
    </>
